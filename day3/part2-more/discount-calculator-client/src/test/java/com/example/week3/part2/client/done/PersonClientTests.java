...
@AutoConfigureStubRunner(stubsMode = StubsMode.LOCAL, ids = "com.example.testingworkshop:discount-calculator-more-done")
...
class PersonClientTests {
	...
	@StubRunnerPort("discount-calculator-more-done")
