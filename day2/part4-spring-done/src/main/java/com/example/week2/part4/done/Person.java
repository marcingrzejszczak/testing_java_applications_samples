...
public class Person {
	...
	public Person(@JsonProperty("name") String name,
				  @JsonProperty("numberOfBoughtGoods") int numberOfBoughtGoods,
	...
	public boolean equals(Object o) {
		...
		return numberOfBoughtGoods == person.numberOfBoughtGoods && Double.compare(person.discountRate,
																				   discountRate) == 0
			   && Objects.equals(name, person.name) && occupation == person.occupation;
	}
